...
@Listeners(Generic_Utilities.ListenerImplementationWithScreenshot.class)
public class CreateCampaignTestWithTakesScreenshot extends BaseClass {
	...
	public void CreateCampaignTest() throws Throwable {
		...
		driver.get(URL);
 		...
 		//for testscript failure it takes screenshot and retry so intentionall failed it
